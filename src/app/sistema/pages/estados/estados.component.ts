...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, SharedModule, TituloComponent, FormularioEstadosComponent]
})
...
export class EstadosComponent{
    ...
    @ViewChild(FormularioEstadosComponent) formulario!: FormularioEstadosComponent;
    ...
    confirm(){
        ...
        this.subscription = this.estadosService.destroy(this.excluir.id || 0).subscribe({
            next: (data) => {
