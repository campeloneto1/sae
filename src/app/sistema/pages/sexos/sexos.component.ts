...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, SharedModule, TituloComponent, FormularioSexosComponent]
})
...
export class SexosComponent implements OnInit, OnDestroy{
    ...
    @ViewChild(FormularioSexosComponent) formulario!: FormularioSexosComponent;
    ...
    confirm(){
        ...
        this.subscription = this.sexosService.destroy(this.excluir.id || 0).subscribe({
            next: (data) => {
